...
import com.example.ForestFirePrediction.Security.filter.CustomAuthenticationFilter;
import com.example.ForestFirePrediction.Security.filter.CustomAuthorizationFilter;
...
//        Custom Authentication Filter for LOGIN
        ...
        http.authorizeRequests().antMatchers(POST, "/api/security/role/save/**").hasAnyAuthority("ROLE_ADMIN");   // Allow Secure Paths to ADMIN
