package com.example.ForestFirePrediction.Security.api;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.example.ForestFirePrediction.Security.forms.Form;
...
//    Save a new User to Database
    ...
    public ResponseEntity<AppUser> saveUser(@RequestBody Form.SaveUserForm form) throws IOException {
        ...
        return ResponseEntity.created(uri).body(userService.saveUser(form.getUsername(), form.getPassword(), form.getDesignation(), form.getPfp(), form.getRoles()));
    }

//    Update User
    @PutMapping("/user/update")
    public ResponseEntity<String> updateUser(@RequestBody Form.UpdateUserForm form) throws IOException {
        userService.updateUser(form.getUsername(), form.getDesignation(), form.getPfp(), form.getRoles());
