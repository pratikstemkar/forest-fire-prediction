...
public interface UserService {
    ...
    AppUser saveUser(String username, String password, String designation, String pfp, List<String> roles) throws IOException;
    void updateUser(String username, String designation, String pfp, List<String> roles) throws IOException;
