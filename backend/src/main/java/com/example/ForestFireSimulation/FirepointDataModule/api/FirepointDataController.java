package com.example.ForestFireSimulation.FirepointDataModule.api;

import com.example.ForestFireSimulation.FirepointDataModule.forms.DivisionForm;
...
import com.example.ForestFireSimulation.FirepointDataModule.service.FirepointDataService;
import com.example.ForestFireSimulation.FirepointDataModule.service.FirepointSpeciesDamagedService;
import com.example.ForestFireSimulation.FirepointDataModule.service.FirepointWildlifeAffectedService;
...
public class FirepointDataController {
    ...
    public ArrayList<FirepointData> getRoData(@PathParam("username") String username) {
        return firepointDataService.getRoData(username);
    }
