...
// User URLs
export const USER_URL = "/api/security/user/";
export const AU_URL = "/api/security/users";
export const SU_URL = "/api/security/user/save";
export const DU_URL = "/api/security/user/delete/";
export const UU_URL = "/api/security/user/update";

// Dashboard URLs
export const CP_URL = "/api/security/user/password/update";
export const CU_URL = "/api/security/user/username/update";
export const CPFP_URL = "/api/security/user/pfp/update";

// Role URLs
export const ROLE_URL = "/api/security/role/";
export const GR_URL = "/api/security/roles";
export const SR_URL = "/api/security/role/save";
